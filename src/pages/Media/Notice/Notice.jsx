            ...
            <div className="col-md-4 col-lg-4">
              <div className="single-article">
                <div className="article-img">
                  <a href="/LatestArticlesDetails"><img src="https://img.freepik.com/free-vector/announcement-background-design_23-2151138205.jpg" alt="" /></a>
                  <div className="article-date">
                    <p>Feb 20, 2024</p>
                  </div>
                </div>
                <a href="/LatestArticlesDetails"><h2>ঈদ-ঊল-মিলাদুন্নবী উপলক্ষে অফিস বন্ধ
                    মনির গ্রুপের সকল কর্মকর্তা এবং...</h2></a>
              </div>
            </div>
          </div>
        </div>
