...
import FardinBrandingInfo from './FardinBrandingInfo'
import FardinManagment from './FardinManagment'
import FardinTeam from './FardinTeam'

const FardinBranding = () => {
    return (
        <>
            <FardinBrandingInfo />
            <FardinManagment />
